...
from examples.example_extern_module import Function1
from examples.example_extern_module import Function2
...
def main():
    threads = {}
    threads["ThreadMircea's"] = thread("ThreadMircea's")
    threads["ThreadMircea's"].add_node(node("Node1", {}, {}, threads["ThreadMircea's"]))
    threads["ThreadMircea's"].get_node("Node1").add_function("Function1", function("Function1", Function1, threads["ThreadMircea's"].get_node("Node1")))
    threads["ThreadMircea's"].get_node("Node1").get_function("Function1").add_arg_setable("input1", function_arg_setable("input1", threads["ThreadMircea's"].get_node("Node1").get_function("Function1")))
    threads["ThreadMircea's"].add_node(node("Node2", {}, {}, threads["ThreadMircea's"]))
    threads["ThreadMircea's"].get_node("Node2").add_function("Function2", function("Function2", Function2, threads["ThreadMircea's"].get_node("Node1")))
    threads["ThreadMircea's"].get_node("Node2").get_function("Function2").add_arg_setable("input1", function_arg_setable("input1", threads["ThreadMircea's"].get_node("Node2").get_function("Function2")))
    threads["Thread2"] = thread("Thread2")
    return
